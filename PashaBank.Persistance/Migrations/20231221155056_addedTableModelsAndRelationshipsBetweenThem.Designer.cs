...
namespace PashaBank.Repository.Migrations
{
    ...
    [Migration("20231221155056_addedTableModelsAndRelationshipsBetweenThem")]
    partial class addedTableModelsAndRelationshipsBetweenThem
    {
            ...
            modelBuilder.Entity("PashaBank.Core.Models.Recommendation", b =>
                {
                    ...
                    b.HasOne("PashaBank.Core.Models.User", null)
